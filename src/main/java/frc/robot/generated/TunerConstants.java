...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 10.45;
    ...
    // Front Left
    private static final int kFrontLeftDriveMotorId = 58;
    private static final int kFrontLeftSteerMotorId = 61;
    private static final int kFrontLeftEncoderId = 53;
    private static final double kFrontLeftEncoderOffset = 0.189697265625;

    private static final double kFrontLeftXPosInches = 12.375;
    private static final double kFrontLeftYPosInches = 12.375;

    // Front Right
    private static final int kFrontRightDriveMotorId = 59;
    private static final int kFrontRightSteerMotorId = 60;
    private static final int kFrontRightEncoderId = 50;
    private static final double kFrontRightEncoderOffset = 0.11669921875;
    ...
    private static final int kBackLeftSteerMotorId = 57;
    ...
    private static final double kBackRightEncoderOffset = 0.18408203125;
