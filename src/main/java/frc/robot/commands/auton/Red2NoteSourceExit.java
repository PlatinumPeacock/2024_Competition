...
public class Red2NoteSourceExit extends SequentialCommandGroup {
  /** Creates a new Red2NoteExit. */
  public Red2NoteSourceExit(Feeder f, Intake i, Shooter s, CommandSwerveDrivetrain dt, SwerveRequest.FieldCentric d) {
